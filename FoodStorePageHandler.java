...
public class FoodStorePageHandler implements HttpHandler {
    public void handle(HttpExchange he) throws IOException{
        String response = "Welcome to our Store Inventory";
        he.sendResponseHeaders(200, 0);
        BufferedWriter out = new BufferedWriter(
                new OutputStreamWriter(he.getResponseBody()));
        FoodProductDAO foodProductDAOServer = new FoodProductDAO();
        List<FoodProduct> allFoodProducts = foodProductDAOServer.findAllProducts();
...
//                        WEB CONTENT
                        ...
                        "<a href=\"foodStore\" style=\"color: #F86532; font-weight: 900;\"><p>Products</p></a>" +
                        ...
                        "<h1 class=\"section_title\">Products in <span class=\"title_span\">our Store</h1>" +
                        "<h3 class=\"section_subtitle\">We provide you with the best food products in wholesale</h3>" +
                        ...
                        "<thead>"+
                        "<tr>"+
                        "<th>S/NO</th>"+"<th>Product Name</th>"+"<th>SKU</th>"+"<th>Description</th>"+"<th>Category</th>"+"<th>Price (Pounds)</th>"+
                        "</tr>"+
                        "</thead>"+
                        "<tbody>");

//        Display the Food Product values
        for(FoodProduct d: allFoodProducts){
